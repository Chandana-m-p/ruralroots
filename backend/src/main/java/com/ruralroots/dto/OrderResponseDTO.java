...
public class OrderResponseDTO {
    ...
    public OrderResponseDTO(Long id, String orderNumber, UUID idempotencyKey, Long buyerId, String buyerPhone, String buyerName, Long hubId, String hubName, String hubLandmark, String orderStatus, String paymentType, String paymentStatus, BigDecimal totalAmount, ZonedDateTime offlineCreatedAt, ZonedDateTime syncedAt, ZonedDateTime deliveryDate, String cancellationReason, ZonedDateTime cancelledAt, List<OrderItemDTO> items) {
        this.id = id;
    ...
    public static class OrderResponseDTOBuilder {
        ...
        public OrderResponseDTO build() {
            return new OrderResponseDTO(id, orderNumber, idempotencyKey, buyerId, buyerPhone, buyerName, hubId, hubName, hubLandmark, orderStatus, paymentType, paymentStatus, totalAmount, offlineCreatedAt, syncedAt, deliveryDate, cancellationReason, cancelledAt, items);
        }
    }
